...
const DB = {
  ...
  /* ---------------------- 재무회계(FI): 손익계산서 / 재무상태표 (당월, 원) ----------------------
   * 직접 입력하는 항목들. 매출채권·매입채무·재고자산은 다른 데이터에서 자동 집계.
   */
  finance: {
    period: "2026년 6월",
    // 손익계산서
    sales: 150000000,        // 매출액
    cogs: 96000000,          // 매출원가
    sga: 32000000,           // 판매비와관리비
    nonOpIncome: 800000,     // 영업외수익
    nonOpExpense: 1200000,   // 영업외비용
    corpTax: 2100000,        // 법인세비용
    // 재무상태표 (직접입력 항목)
    cash: 84500000,          // 현금및현금성자산
    tangible: 120000000,     // 유형자산(설비 등)
    otherAsset: 5000000,     // 기타자산
    shortLoan: 50000000,     // 단기차입금
    otherLiab: 8000000,      // 기타부채
    capital: 100000000,      // 자본금
  },

  /* ---------------------- 재무회계(FI): 총계정원장 ---------------------- */
  glLedger: [
    { id: "GL01", date: "2026-06-12", account: "외상매출금", desc: "유라코퍼레이션 납품", debit: 24500000, credit: 0 },
    { id: "GL02", date: "2026-06-11", account: "외상매입금", desc: "협진전선 자재대금 지급", debit: 0, credit: 14080000 },
    { id: "GL03", date: "2026-06-10", account: "보통예금",   desc: "경신 수금 입금", debit: 18750000, credit: 0 },
    { id: "GL04", date: "2026-06-05", account: "급여",       desc: "생산직 급여 지급", debit: 32400000, credit: 0 },
    { id: "GL05", date: "2026-06-02", account: "지급임차료", desc: "공장 임차료", debit: 4500000, credit: 0 },
  ],
};
